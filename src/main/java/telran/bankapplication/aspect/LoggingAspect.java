package telran.bankapplication.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(public * telran.bankapplication.controller.*.*(..))")
    public void controllerLog() {
    }

    @Pointcut("execution(public * telran.bankapplication.service.*.*(..))")
